                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-blue-50 rounded-lg">
                      <h4 className="font-medium">Dr. Andre P. Marshall</h4>
                      <p className="text-sm text-gray-600">M.D., MPH, F.A.C.S.</p>
                      <div className="flex flex-wrap gap-1 mt-2">
                        <Badge variant="secondary">Rhinoplasty</Badge>
                        <Badge variant="secondary">Facelift</Badge>
                        <Badge variant="secondary">Lip Fillers</Badge>
                      </div>
                    </div>
                    <div className="p-3 bg-green-50 rounded-lg">
                      <h4 className="font-medium">Dr. Catherine Loflin</h4>
                      <p className="text-sm text-gray-600">MD, FACS</p>
                      <div className="flex flex-wrap gap-1 mt-2">
                        <Badge variant="secondary">Upper Arm Lift</Badge>
                        <Badge variant="secondary">Tummy Tuck</Badge>
                        <Badge variant="secondary">Facelift</Badge>
                      </div>
                    </div>
                  </div>
